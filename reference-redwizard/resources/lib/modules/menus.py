...
from .addonvar import addon_name, setting, addon_icon, addon_fanart, local_string, authorize, kodi_ver, kodi_versions, chk_splash, chk_skin_override, thumbnailsize, packagesize, buildsize, cleanup, headers, home, UPDATE_VERSION, CURRENT_BUILD, BUILD_VERSION, BUILD_NAME, NUM_BUILDS
...
def main_menu():
    ...
    add_dir(COLOR2(local_string(30026)),'',10,addon_icon,addon_fanart,COLOR2(local_string(30067)), isFolder=False)  # Authorize Debrid Services

    add_dir(COLOR2(local_string(30070)),'',36,addon_icon,addon_fanart,COLOR2(local_string(30071)), isFolder=False)  # Add MDbList Key
